...
class TestBookingForm(TestCase):
    ...
    def test_guests_is_required(self):
        ...
        self.assertFalse(
            ...
            msg='field guests is valid'
            )

    def test_fields_are_explicit_in_form_metaclass(self):
        booking_form = BookingForm()
        self.assertEqual(
            list(booking_form.Meta.fields),
            ['date', 'time', 'guests']
            )
    ...
    def test_booking_form_is_valid(self):
        ...
        self.assertTrue(
            booking_form.is_valid(), msg='BookingForm is not valid'
            )
    ...
    def test_guests_less_than_one_is_invalid(self):
        ...
        self.assertEqual(booking_form.errors['guests'][0],
    ...
    def test_date_less_than_one_day_in_advanced_is_invalid(self):
        ...
        self.assertEqual(booking_form.errors['date'][0],
    ...
    def test_time_hours_of_business_is_invalid(self):
        ...
        self.assertEqual(
            booking_form.errors['time'][0],
            'Please choose a time between 11:00 am - 22:00 pm'
            )
