...
class TestModels(TestCase):
    ...
    def test_status_default_to_pending(self):
        ...
        self.assertEqual(booking.status, 'pending', msg='Default status is not pending')
    ...
    def test_booking_str_method(self):
        ...
        expected= f"Booking by {self.user.username} on {booking.date} at {booking.time} | created at: {booking.created_at}"
